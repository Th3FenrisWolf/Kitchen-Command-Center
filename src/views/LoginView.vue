...
<template>
  <div class="place-items-center content-center">
    <div class="shadow-primary relative flex w-3/4 overflow-hidden rounded-3xl">
      <div
        :class="
          cx(
            'ease-normal relative left-[0%] flex basis-[60%] flex-col justify-center gap-4 p-12 text-center transition-all duration-300',
            swap && 'left-[40%]',
          )
        "
      >
      ...
      <div
        :class="
          cx(
            'bg-base ease-normal relative right-[0%] basis-[40%] justify-items-center overflow-hidden p-12 text-center transition-all duration-300',
            swap && 'right-[60%]',
          )
        "
      >
        <div
          :class="
            cx(
              'ease-normal relative flex h-full w-[400%] justify-between transition-all duration-300',
