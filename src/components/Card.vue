...
<template>
  <div
    :class="
      cx(
        'shadow-primary group/card ease-normal flex flex-col justify-center gap-2 rounded-3xl p-4 text-center transition-all duration-500',
  ...
  >
    <div
      :class="
        cx(
          'ease-normal relative top-1 transition-all duration-500',
    ...
    <div
      :class="
        cx(
          'ease-normal h-[0%] content-center overflow-hidden rounded-2xl transition-all duration-500',
