...
const report = {
  ...
  suites: [
    {
      id: "unit", label: "Unit", type: "dotnet", status: "ok",
      summary: { total: 2, passed: 1, failed: 1, skipped: 0, cancelled: 0, timedOut: 0 },
      durationMs: 592, meta: { framework: "TUnit" },
      groups: [{
        name: "AccountViewModelTests", namespace: "KCC.UnitTests",
        summary: { total: 2, passed: 1, failed: 1, skipped: 0, cancelled: 0, timedOut: 0 },
        tests: [
    ...
    {
      id: "admin-frontend", label: "Admin Frontend", type: "vitest", status: "missing",
      errorDetail: "No results found", summary: { total: 0, passed: 0, failed: 0, skipped: 0, cancelled: 0, timedOut: 0 },
      durationMs: 0, groups: [],
    },
  ],
};
      ...
      suites: [
        {
          ...
          durationMs: 1,
          groups: [
            { name: "Passing", summary: { total: 1, passed: 1, failed: 0, skipped: 0, cancelled: 0, timedOut: 0 }, tests: [{ name: "a", status: "passed", durationMs: 1 }] },
            { name: "HasFailure", summary: { total: 2, passed: 0, failed: 1, skipped: 1, cancelled: 0, timedOut: 0 }, tests: [{ name: "b", status: "failed", durationMs: 1, errorMessage: "x" }, { name: "c", status: "skipped", durationMs: 0 }] },
          ],
        },
      ],
    };
